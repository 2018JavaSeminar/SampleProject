...
public class StaticFilePathCssProcessor extends AbstractAttributeTagProcessor {

	private static String ATTE_NAME = "cssPath";
	private static String SET_PARAM_HREF = "href";
	private static String STATIC_FILE_PATH = "/assets/";

	public StaticFilePathCssProcessor(String dialectPrefix) {
